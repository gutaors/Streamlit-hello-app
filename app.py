#
# Aqui no vscode fui em 
#   Terminal, new Terminal 
# daí no terminal rodei 
#   pip install streamlit
# o streamlit permite criar aplicações web sem
# precisar de flask, django etc...
# ele cria mini soluções
# daqui pra baixo ele cria este aplicativo
# para executar este código vamos no terminal
...
# esta notacao aqui embaixo diz q tem
# que ficar em cache do streamlit
# a funcao get_data() pega dados e cria um dataframe
@st.cache
def get_data():
...
# definindo a faixa de valores (entre o valor minimo de MEDV até 150)
faixa_valores = st.slider("Faixa de preço", float(data.MEDV.min()), 150., (10.0, 100.0))

# filtrando os dados (pega entre valor mínimo e máximo da faixa de valores, armazena na var dados)
